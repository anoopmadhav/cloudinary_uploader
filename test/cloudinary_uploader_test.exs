defmodule CloudinaryUploaderTest do
  ...
  test "Video Upload" do
    assert {:ok, %CloudinaryUploader.Response{}} = 
      upload("https://sample-videos.com/video123/mp4/720/big_buck_bunny_720p_1mb.mp4", resource_type: :video)
  end

  test "Audio Upload" do
    assert {:ok, %CloudinaryUploader.Response{}} = 
      upload("https://sample-videos.com/audio/mp3/crowd-cheering.mp3", resource_type: :video)
  end
  ...
  test "Video Upload with public id" do
    assert {:ok, %CloudinaryUploader.Response{}} = 
      upload("https://sample-videos.com/video123/mp4/720/big_buck_bunny_720p_1mb.mp4", resource_type: :video, public_id: "sample_video")
  end
